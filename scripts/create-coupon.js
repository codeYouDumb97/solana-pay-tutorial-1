...
console.log("Coupon created:", myCouponAddress.toString())

// Create the associated token account for the shop
console.log("Creating coupon token account for the shop...")
...
console.log("Coupon token account created:", shopCouponAddress.toString())
